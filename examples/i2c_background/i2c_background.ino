...
void setup()
{
  ...
  int16_t ret = dsp.startMeasureBothCont(temp_mr, temp_osr, prs_mr, prs_osr);
...
void loop()
{
  ...
  int16_t ret = dsp.getContResults(temperature, temperatureCount, pressure, pressureCount);
